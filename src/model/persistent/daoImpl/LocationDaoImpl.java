...
public class LocationDaoImpl implements LocationDao {
	...
	public List<Object[]> list() {
		...
		// Se crea la consulta
		String jpql = "SELECT l.id, l.name, ci.city, co.county, c.country, (SELECT COUNT(p) FROM Production p JOIN p.scenes s WHERE l = s.location) FROM Location l JOIN l.city ci JOIN ci.county co JOIN co.country c ORDER BY l.id DESC";
